...
{
    //The code token form https://github.com/endjin/Endjin.Retry 
    /// <summary>
    ...
    public static class PeriodicTaskFactory
    {
            ...
            TaskCreationOptions periodicTaskCreationOptions = TaskCreationOptions.None)
        {
            ...
            Action mainAction = () => { MainPeriodicTaskAction(intervalInMilliseconds, delayInMilliseconds, duration, maxIterations, cancelToken, stopWatch, synchronous, wrapperAction, periodicTaskCreationOptions); };
